...
/* ================================================================
   COMMON MACRO + %INCLUDE LOGIC
   ================================================================ */
%macro clean_customer_data(input=, output=);
...
%mend clean_customer_data;

/* Call the macro */
%clean_customer_data(input=work.raw_transactions, output=work.clean_transactions);
